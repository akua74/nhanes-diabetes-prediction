...
# ⭐ **COPY & PASTE THIS ENTIRE FILE INTO `report/report.Rmd`**
...
Great — below is a **clean, formatted R Markdown section** that you can paste **directly into your `report/report.Rmd`**.

I structured it to fit perfectly under a **Results**, **Discussion**, or **Findings** section.
It uses proper Markdown headers, integrates with your figures automatically, and reads like a polished graduate-level analysis.
